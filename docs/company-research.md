...
회사 조사(당시 `add-company`, 지금은 `research-role`의 뻗기)가 어느 소스를 직접 부르고 어느 소스는 검색·사람 눈으로 넘기는지, 사업보고서 원문을 왜 그렇게 파싱하는지의 **실측 기록**이다. 결정은 [`rationale.md`](rationale.md) #5·#6에 있고, 여기는 그 결정이 딛고 선 숫자다. 근거 등급은 ① 실행 결과 ② 출처 ③ 감. 측정일 2026-09-04~06.
